...
import { Sparkles, User, LogOut, PenLine, Home, FileText, Wallet, ShieldCheck, Trophy, Crown } from 'lucide-vue-next'
    ...
    <nav class="bg-white border-b sticky top-0 z-20 shadow-sm">
      <div class="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div class="flex items-center gap-6">
          ...
          <router-link to="/vip" class="text-amber-600 hover:text-amber-700 flex items-center gap-1 font-medium transition">
            <Crown class="w-4 h-4" /> 会员专区
          </router-link>
